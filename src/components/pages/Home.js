                ...
                {post &&
                    post.map((post, index) => (
                                <div className="homepost">
                                    <img src="..." className="post_images" alt="..." src={`http://localhost:5000/${post.image}`}/>
                                    ...
                                    <button onClick={() => deletePost(post._id)} className="btn btn-delete btn-block"><i class="fa fa-trash" aria-hidden="true"></i></button>
